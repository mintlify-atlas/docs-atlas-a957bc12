...
Timelines allow you to create complex, sequenced animations where multiple elements animate in a coordinated sequence. In Motion, timelines are created using the `animate()` function with sequence syntax.
